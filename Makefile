GXX=g++
GXX_FLAGS=-c -g -Wall -Werror -pedantic -std=c++11

cursestest: main.o Map.o MapGen.o Cst.o Cch.o Space.o Enemy.o Player.o functions.o Command.o Menu.o Option.o Point.o Item.o Artifact.o Weapon.o generation.o Branch.o
	$(GXX) -lncurses -lboost_serialization main.o Map.o MapGen.o Cst.o Cch.o Space.o Enemy.o Player.o functions.o Command.o Menu.o Option.o Point.o Item.o Artifact.o Weapon.o generation.o Branch.o -o $@
...
Enemy.o: Enemy.cpp Point.o Map.o functions.o generation.o Player.o
